...
// router.get("/view-all-decision/:decision", async (req, res) => {
//     User.find({ usertype: "candidate", decision: req.params.decision })
//         .then((candidates) => {
//             if (!candidates) {
//                 console.log(req.params.decisions),
//                 res.status(200).json({
...
//         });
// });
router.get("/view-all-accepted", async (req, res) => {
    User.find({ usertype: "candidate", decision: {not:"pending"} })
        .then((candidates) => {
            if (!candidates) {
